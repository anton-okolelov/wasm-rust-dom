...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasmtest.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasmtest.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasmtest.asm.js';
...
var ASM_CONSTS = [function($0, $1, $2, $3, $4) { WEBPLATFORM.rs_refs[$0].addEventListener(UTF8ToString($1), function (e) {Runtime.dynCall('viii', $3, [$2, $4, e.target ? WEBPLATFORM.rs_refs.push(e.target) - 1 : -1]);}, false); },
 ...
 function($0) { alert(UTF8ToString($0)); },
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasmtest.js.mem" : null;




var STATIC_BUMP = 17840;
